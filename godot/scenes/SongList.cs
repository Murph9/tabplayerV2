...
public partial class SongList : VBoxContainer {
    class Column(string name, Func<SongFile, object> value) {
        public string Name { get; private set; } = name;
        public bool Sorted => Sort != null;
        public Func<SongFile, object> Sort { get; private set; } = value;
    ...
    private static readonly List<Column> HEADINGS = [
